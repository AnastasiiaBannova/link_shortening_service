...
# you have to import every table, for applying it in base metadata
from link_shortening_service.repositories.postgres.models import base
...
def run_migrations_online():
    ...
    _config["sqlalchemy.url"] = get_postgres_url()
